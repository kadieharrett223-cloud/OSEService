    ...
    Tables: {
      ...
      shipping_order_lines: {
        Row: {
          ...
          legacy_warehouse_status: string | null;
          legacy_priority_flag: string | null;
          legacy_fulfillment_method: string | null;
          legacy_expected_by: string | null;
          legacy_qbo_shipping_method: string | null;
          legacy_floor_assignment: Json | null;
