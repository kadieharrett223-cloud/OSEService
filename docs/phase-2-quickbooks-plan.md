...
- Create-case customer card auto-fills from QuickBooks, but shipping address is editable in-app for support corrections and does not write back to QuickBooks.
