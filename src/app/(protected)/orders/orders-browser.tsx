...
export function OrdersBrowser({ rows, tabCounts, initialTab, initialPage, searchText }: {
  ...
  return <>
    ...
    <div className="rounded-2xl border border-[#e5e7eb] bg-white p-6 shadow-sm">
      {activeTab === "warehouse" ? <div className="mb-4 flex flex-wrap items-center justify-between gap-3 rounded-xl border border-[#bfdbfe] bg-[#eff6ff] p-4"><div><p className="font-semibold text-[#1e3a8a]">Freight consolidation</p><p className="mt-1 text-sm text-[#475569]">Preview orders that may share a truck or delivery route.</p></div><Link href="/freight-consolidation" className="btn-primary inline-flex">Find combined shipments</Link></div> : null}
